...
DEFAULT_SETTINGS = (
    ...
    (
        "billing_partial_end_cutoff_days",
        "5",
        "Finance",
        "Partial Billing End Grace Cutoff (days)",
        "integer",
        "If a student joins within the last N days of the month, the partial period is waived as grace and billing starts next month.",
    ),
    (
        "billing_partial_start_cutoff_days",
        "4",
        "Finance",
        "Partial Billing Start Full Cutoff (days)",
        "integer",
        "If a student joins on or before this day of the month, full monthly fee is charged without partial deduction.",
    ),
    (
        "billing_partial_round_to",
        "50",
        "Finance",
        "Partial Billing Rounding Amount (Rs.)",
        "integer",
        "Round calculated partial month fees to the nearest multiple (e.g. 50 rounds Rs. 1,161 to Rs. 1,150).",
    ),
    (
        "billing_partial_base_days",
        "30",
        "Finance",
        "Partial Billing Base Days",
        "integer",
        "Standard number of days per month used to calculate daily fee rate for partial month billing (default 30).",
    ),
    (
